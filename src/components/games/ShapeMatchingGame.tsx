...
const ShapeMatchingGame = ({ onBack }: ShapeMatchingGameProps) => {
  const initialShapes: Shape[] = [
    ...
    { id: 5, type: "circle", color: "bg-yellow-400", matched: false },
    { id: 6, type: "square", color: "bg-blue-500", matched: false },
    { id: 7, type: "triangle", color: "bg-red-500", matched: false },
    { id: 8, type: "star", color: "bg-success", matched: false },
  ];
